...
<html lang="en">
<head>
    <title>Code coverage report for craco-less.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> craco-less.js
    </h1>
    <div class='clearfix'>
...
150
151
152</td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
  const loaders = sassRule.use || <span class="branch-1 cbranch-no" title="branch not covered" >sassRule.loader;</span>
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (rule.loader.includes(`${pathSep}resolve-url-loader${pathSep}`)) {
<span class="cstat-no" title="statement not covered" >      lessRule.use.push({</span>
        loader: rule.loader,
        options: {
          ...rule.options,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Aug 20 2019 11:29:16 GMT+0600 (+06)
</div>
</div>
